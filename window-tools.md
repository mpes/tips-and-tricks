...
# [Q-Dir](http://softwareok.com/?seite=Freeware/Q-Dir) lets you wor with 4 different Explorer windows inside one application.
...
# [Sublime Text 3](https://download.sysinternals.com/files/ProcessExplorer.zip) is one of the top-notch text editors
* Very versatile
* Lightweight
